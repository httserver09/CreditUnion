    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "accounts",
                columns: new[] { "id", "accountType", "activatedDate", "baseAmount", "clientId" },
                values: new object[,]
                {
                    { 1, "Savings", new DateTime(2018, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 55000.0, 1 },
                    { 2, "Savings", new DateTime(2019, 4, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 145788.98999999999, 2 }
                });
